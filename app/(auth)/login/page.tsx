...
export default function LoginPage() {
  return (
    <main className="relative flex min-h-dvh w-full items-center justify-center overflow-x-hidden bg-[#090b11] px-3 py-6 font-sans antialiased selection:bg-indigo-500/30 sm:px-4 sm:py-10">
      ...
      <div className="absolute top-[-10%] left-[-10%] h-125 w-125 rounded-full bg-slate-800/20 blur-[120px]" />
      <div className="absolute bottom-[-10%] right-[-10%] h-125 w-125 rounded-full bg-indigo-950/20 blur-[120px]" />
      ...
      <div className="z-10 w-full max-w-md">
        {/* Header Branding */}
        <div className="mb-5 space-y-1 text-center sm:mb-6">
          <h1 className="font-mono text-2xl font-bold uppercase tracking-[0.22em] text-slate-200 sm:text-3xl sm:tracking-widest">
            RPS Arena
          </h1>
          <p className="text-[10px] font-medium uppercase tracking-[0.22em] text-slate-400 sm:text-[16px] sm:tracking-[0.25em]">
            Play Win Earn Own
          </p>
        </div>
